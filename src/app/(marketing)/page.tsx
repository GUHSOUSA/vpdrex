...
const MarketingPage = () => {
    ...
    return (
        <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
            <Wrapper>
                <div className="absolute inset-0 bg-[linear-gradient(to_right,#0b1026c3_1px,transparent_1px),linear-gradient(to_bottom,#0b1026c3_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] -z-10 h-[150vh]" />
                <Container>
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-3">
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            ...
                            <p className="text-sm md:text-lg text-foreground/80 mt-6 text-center">
                                Conecte sua VPS à VPDREX e automatize o deploy das suas aplicações, independentemente da linguagem. Simples, rápido e eficiente.
                            </p>
                            <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                                <Link href="#" className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40 cursor-pointer select-none">
                                    <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                                        🚀 Comece agora a automatizar seus deploys!
                                    </p>
                                    <Button size="sm" className="rounded-full hidden lg:flex border border-foreground/20" onClick={() => setOpen(true)}>
                                        Criar Conta
                        ...
                        <div className="relative mx-auto max-w-7xl rounded-xl lg:rounded-[32px] border border-neutral-200/50 p-2 backdrop-blur-lg border-neutral-700 bg-neutral-800/50 md:p-4 mt-12">
                            ...
                            <div className="rounded-lg lg:rounded-[24px] border  border-neutral-700 ">
                                <Image
                                    src="/dashboard.png"
                                    alt="dashboard"
                                    width={1920}
